...
const scheduler_prototype = global.Object.create(Object, {
    ...
    _eventListComparator: {
         ...
         * @return {number}
         */
        value: function _eventListComparator (/** SSASubtitleEvent */ a, /** SSASubtitleEvent */ b) {
    ...
    _constructFixedArray: {
         ...
         */
        value: function _constructFixedArray (len) {
    ...
    "getVisibleAtTime": {
         ...
         */
        value: function getVisibleAtTime (time) {
            let array = [];
            if (
    ...
    "setEvents": {
         ...
         */
        value: function setEvents (eventsList) {
...
sabre["SubtitleScheduler"] = function SubtitleScheduler () {
