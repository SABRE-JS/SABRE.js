    ...
    describe("SSATransitionTargetOverride", () => {
        ...
        describe("#toJSON", () => {
            it("should return style override object", () => {
                expect(transitionTargetOverride.toJSON()).toEqual(
                    defaultTransitionTargetOverride
                );
            });
        });
        ...
        utils.testArrayValuesMethod(
            sabre.SSATransitionTargetOverride(),
            "Rotation",
            "r",
            ...constants.rotations
        );
        testPrimitiveMethods(
            sabre.SSATransitionTargetOverride(),
            constants.transitionTargetOverridePrimitiveFieldsAliases
        );
    });
    ...
    describe("SSAStyleOverride", () => {
        ...
        describe("change font size mod", () => {
            ...
            describe("#increaseFontSizeMod", () => {
                it("should increase font size based on passed size", () => {
                    ...
                    expect(styleOverride.getFontSizeMod()).toBe(
                        defaultFontSize
                    );
            ...
            describe("#decreaseFontSizeMod", () => {
                it("should decrease font size based on passed size", () => {
                    styleOverride.setFontSizeMod(defaultFontSize);
                    expect(styleOverride.getFontSizeMod()).toBe(
                        defaultFontSize
                    );
        ...
        describe("set custom margins", () => {
            it("should set margin left", () => {
                ...
                expect(styleOverride.getMargins()).toEqual([
        ...
        describe("#reset", () => {
            ...
            it("should reset style override object", () => {
                ...
                expect(styleOverride.toJSON()).not.toEqual(
                    defaultStyleOverride
                );
        ...
        describe("#clone", () => {
            ...
            it("should clone style override object", () => {
                ...
                expect(styleOverride.toJSON()).not.toEqual(
                    modifiedStylOverride
                );
                expect(clonedStyleOverride.toJSON()).toEqual(
                    modifiedStylOverride
                );
            });
        });
    ...
    describe("SSALineStyleOverride", () => {
        ...
        describe("#toJSON", () => {
            beforeEach(() => {
                ...
                lineStyleOverride.setRotationOrigin(
                    rotationOriginX,
                    rotationOriginY
                );
                lineStyleOverride.setFade(
                    fadeA1,
                    fadeA2,
                    fadeA3,
                    fadeT1,
    ...
    describe("SSALineTransitionTargetOverride", () => {
        ...
        describe("#setClip", () => {
            it("should set clip value from passed arguments", () => {
                ...
                expect(lineTransitionTargetOverride.toJSON().cl).toEqual(
                    expectedClip
                );
            });
        });
